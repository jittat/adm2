"""
ThaiSelectDateWidget is a modification from
django.forms.extra.widgets.SelectDateWidget to handle Thai-style date.
"""
...
class ThaiSelectDateWidget(Widget):
    """
    ...
    def render(self, name, value, attrs=None):
        ...
        year_choices = [(i, i+543) for i in self.years]
        if not (self.required and value):
