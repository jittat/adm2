...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Applicant.birth_date'
        db.delete_column('application_applicant', 'birth_date')
        
        # Deleting field 'Applicant.ethnicity'
        db.delete_column('application_applicant', 'ethnicity')
        
        # Deleting field 'Applicant.nationality'
        db.delete_column('application_applicant', 'nationality')
        
        # Deleting field 'Applicant.phone_number'
        db.delete_column('application_applicant', 'phone_number')
        
        # Deleting field 'Applicant.national_id'
        db.delete_column('application_applicant', 'national_id')
        
    
    
    def backwards(self, orm):
        
        # Adding field 'Applicant.birth_date'
        db.add_column('application_applicant', 'birth_date', models.DateField(verbose_name="วันเกิด"))
        
        # Adding field 'Applicant.ethnicity'
        db.add_column('application_applicant', 'ethnicity', models.CharField(max_length=50, verbose_name="เชื้อชาติ"))
        
        # Adding field 'Applicant.nationality'
        db.add_column('application_applicant', 'nationality', models.CharField(max_length=50, verbose_name="สัญชาติ"))
        
        # Adding field 'Applicant.phone_number'
        db.add_column('application_applicant', 'phone_number', models.CharField(max_length=20, verbose_name="หมายเลขโทรศัพท์"))
        
        # Adding field 'Applicant.national_id'
        db.add_column('application_applicant', 'national_id', models.CharField(max_length=20, verbose_name="เลขประจำตัวประชาชน"))
