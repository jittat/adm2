...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Creating unique_together for [email] on Applicant.
        db.create_unique('application_applicant', ['email'])
        
    
    
    def backwards(self, orm):
        
        # Deleting unique_together for [email] on Applicant.
        db.delete_unique('application_applicant', ['email'])
