...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Applicant.activation_required'
        db.add_column('application_applicant', 'activation_required', orm['application.applicant:activation_required'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Applicant.activation_required'
        db.delete_column('application_applicant', 'activation_required')
