...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('application_passwordrequestlog', (
            ('id', orm['application.passwordrequestlog:id']),
            ('applicant', orm['application.passwordrequestlog:applicant']),
            ('last_request_at', orm['application.passwordrequestlog:last_request_at']),
            ('num_requested_today', orm['application.passwordrequestlog:num_requested_today']),
        ))
