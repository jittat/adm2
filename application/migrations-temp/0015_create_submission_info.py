...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('application_submissioninfo', (
            ('applicantion_id', orm['application.submissioninfo:applicantion_id']),
            ('applicant', orm['application.submissioninfo:applicant']),
            ('salt', orm['application.submissioninfo:salt']),
        ))
