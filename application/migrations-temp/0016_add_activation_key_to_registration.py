...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.add_column('application_registration', 'activation_key', orm['application.registration:activation_key'])
        
        # Changing field 'Address.road'
        # (to signature: django.db.models.fields.CharField(max_length=50, null=True, blank=True))
        db.alter_column('application_address', 'road', orm['application.address:road'])
    ...
    def backwards(self, orm):
        ...
        db.delete_column('application_registration', 'activation_key')
