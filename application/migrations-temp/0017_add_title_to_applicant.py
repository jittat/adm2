...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Applicant.title'
        db.add_column('application_applicant', 'title', orm['application.applicant:title'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Applicant.title'
        db.delete_column('application_applicant', 'title')
