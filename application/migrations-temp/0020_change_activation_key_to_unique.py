...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Creating unique_together for [activation_key] on Registration.
        db.create_unique('application_registration', ['activation_key'])
        
    
    
    def backwards(self, orm):
        
        # Deleting unique_together for [activation_key] on Registration.
        db.delete_unique('application_registration', ['activation_key'])
