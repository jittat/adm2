...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Address.phone_number'
        # (to signature: django.db.models.fields.CharField(max_length=35))
        db.alter_column('application_address', 'phone_number', orm['application.address:phone_number'])
        
        # Changing field 'PersonalInfo.phone_number'
        # (to signature: django.db.models.fields.CharField(max_length=35))
        db.alter_column('application_personalinfo', 'phone_number', orm['application.personalinfo:phone_number'])
