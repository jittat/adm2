...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Applicant.has_related_model'
        db.add_column('application_applicant', 'has_related_model', orm['application.applicant:has_related_model'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Applicant.has_related_model'
        db.delete_column('application_applicant', 'has_related_model')
    ...
    models = {
        ...
        'application.applicant': {
            ...
            'has_related_model': ('IntegerListField', [], {'default': '[]'}),
