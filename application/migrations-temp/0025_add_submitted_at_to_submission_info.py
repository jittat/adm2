...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubmissionInfo.submitted_at'
        db.add_column('application_submissioninfo', 'submitted_at', orm['application.submissioninfo:submitted_at'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'SubmissionInfo.submitted_at'
        db.delete_column('application_submissioninfo', 'submitted_at')
    ...
    models = {
        ...
        'application.submissioninfo': {
            ...
            'submitted_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True', 'default': '"2009-01-01 00:00"'})
        }
    }
