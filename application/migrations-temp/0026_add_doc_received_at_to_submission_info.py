...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubmissionInfo.doc_received_at'
        db.add_column('application_submissioninfo', 'doc_received_at', orm['application.submissioninfo:doc_received_at'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'SubmissionInfo.doc_received_at'
        db.delete_column('application_submissioninfo', 'doc_received_at')
