...
class Migration:
    ...
    def forwards(self, orm):
        ...
        for submission_info in orm.SubmissionInfo.objects.all():
            applicant = submission_info.applicant
            if not submission_info.submitted_at:
                submission_info.submitted_at = now
            if applicant.doc_submission_method==Applicant.SUBMITTED_ONLINE:
                submission_info.doc_received_at = now
