...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubmissionInfo.doc_reviewed_complete'
        db.add_column('application_submissioninfo', 'doc_reviewed_complete', orm['application.submissioninfo:doc_reviewed_complete'])
        
        # Adding field 'SubmissionInfo.has_been_reviewed'
        db.add_column('application_submissioninfo', 'has_been_reviewed', orm['application.submissioninfo:has_been_reviewed'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'SubmissionInfo.doc_reviewed_complete'
        db.delete_column('application_submissioninfo', 'doc_reviewed_complete')
        
        # Deleting field 'SubmissionInfo.has_been_reviewed'
        db.delete_column('application_submissioninfo', 'has_been_reviewed')
