...
class Migration:
    ...
    def forwards(self, orm):
        db.create_index('application_submissioninfo', ['doc_received_at']) 
        db.create_index('application_submissioninfo', ['doc_reviewed_complete']) 
        db.create_index('application_submissioninfo', ['has_been_reviewed']) 
    

    def backwards(self, orm):
        db.delete_index('application_submissioninfo', ['doc_received_at']) 
        db.delete_index('application_submissioninfo', ['doc_reviewed_complete']) 
        db.delete_index('application_submissioninfo', ['has_been_reviewed']) 
