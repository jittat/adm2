...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Education.updated_at'
        db.add_column('application_education', 'updated_at', orm['application.education:updated_at'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Education.updated_at'
        db.delete_column('application_education', 'updated_at')
