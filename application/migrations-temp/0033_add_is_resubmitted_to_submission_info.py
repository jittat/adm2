...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubmissionInfo.resubmitted_at'
        db.add_column('application_submissioninfo', 'resubmitted_at', orm['application.submissioninfo:resubmitted_at'])
        
        # Adding field 'SubmissionInfo.is_resubmitted'
        db.add_column('application_submissioninfo', 'is_resubmitted', orm['application.submissioninfo:is_resubmitted'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'SubmissionInfo.resubmitted_at'
        db.delete_column('application_submissioninfo', 'resubmitted_at')
        
        # Deleting field 'SubmissionInfo.is_resubmitted'
        db.delete_column('application_submissioninfo', 'is_resubmitted')
