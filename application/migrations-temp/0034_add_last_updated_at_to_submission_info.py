...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubmissionInfo.last_updated_at'
        db.add_column('application_submissioninfo', 'last_updated_at', orm['application.submissioninfo:last_updated_at'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'SubmissionInfo.last_updated_at'
        db.delete_column('application_submissioninfo', 'last_updated_at')
