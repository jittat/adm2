...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('application_applicant', 'national_id', self.gf('django.db.models.fields.CharField')(default='1234567890123', max_length=20), keep_default=False)

        # Deleting field 'PersonalInfo.national_id'
        db.delete_column('application_personalinfo', 'national_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'PersonalInfo.national_id'
        db.add_column('application_personalinfo', 'national_id', self.gf('django.db.models.fields.CharField')(default='1234567890123', max_length=20), keep_default=False)
    ...
    models = {
        ...
        'application.education': {
            ...
            'anet_total_score': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
