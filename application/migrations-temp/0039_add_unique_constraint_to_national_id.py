...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Applicant', fields ['national_id']
        db.create_unique('application_applicant', ['national_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Applicant', fields ['national_id']
        db.delete_unique('application_applicant', ['national_id'])
