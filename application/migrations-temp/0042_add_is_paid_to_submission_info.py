...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubmissionInfo.is_paid'
        db.add_column('application_submissioninfo', 'is_paid', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'SubmissionInfo.paid_at'
        db.add_column('application_submissioninfo', 'paid_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SubmissionInfo.is_paid'
        db.delete_column('application_submissioninfo', 'is_paid')

        # Deleting field 'SubmissionInfo.paid_at'
        db.delete_column('application_submissioninfo', 'paid_at')
    ...
    models = {
        ...
        'application.applyingcondition': {
            'Meta': {'object_name': 'ApplyingCondition'},
        ...
        'application.submissioninfo': {
            ...
            'is_paid': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
