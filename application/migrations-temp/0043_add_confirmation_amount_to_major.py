...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Major.confirmation_amount'
        db.add_column('application_major', 'confirmation_amount', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Major.confirmation_amount'
        db.delete_column('application_major', 'confirmation_amount')
