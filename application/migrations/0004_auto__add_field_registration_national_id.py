...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Registration.national_id'
        db.add_column('application_registration', 'national_id', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Registration.national_id'
        db.delete_column('application_registration', 'national_id')
