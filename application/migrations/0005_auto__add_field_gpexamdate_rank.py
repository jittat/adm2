...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GPExamDate.rank'
        db.add_column('application_gpexamdate', 'rank', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GPExamDate.rank'
        db.delete_column('application_gpexamdate', 'rank')
