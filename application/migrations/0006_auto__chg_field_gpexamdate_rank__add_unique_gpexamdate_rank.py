...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GPExamDate.rank'
        db.alter_column('application_gpexamdate', 'rank', self.gf('django.db.models.fields.IntegerField')(default=1, unique=True))

        # Adding unique constraint on 'GPExamDate', fields ['rank']
        db.create_unique('application_gpexamdate', ['rank'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'GPExamDate', fields ['rank']
        db.delete_unique('application_gpexamdate', ['rank'])

        # Changing field 'GPExamDate.rank'
        db.alter_column('application_gpexamdate', 'rank', self.gf('django.db.models.fields.IntegerField')(null=True))
