...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Major.name'
        db.alter_column('application_major', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))


    def backwards(self, orm):
        
        # Changing field 'Major.name'
        db.alter_column('application_major', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))
