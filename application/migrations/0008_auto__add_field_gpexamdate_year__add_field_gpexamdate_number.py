...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GPExamDate.year'
        db.add_column('application_gpexamdate', 'year', self.gf('django.db.models.fields.IntegerField')(default=2554), keep_default=False)

        # Adding field 'GPExamDate.number'
        db.add_column('application_gpexamdate', 'number', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GPExamDate.year'
        db.delete_column('application_gpexamdate', 'year')

        # Deleting field 'GPExamDate.number'
        db.delete_column('application_gpexamdate', 'number')
