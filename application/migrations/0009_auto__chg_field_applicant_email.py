...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('application_applicant', 'email', self.gf('django.db.models.fields.EmailField')(unique=True, max_length=200))


    def backwards(self, orm):
        
        # Changing field 'Applicant.email'
        db.alter_column('application_applicant', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, unique=True))
