...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Applicant.additional_hashed_password'
        db.add_column('application_applicant', 'additional_hashed_password', self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Applicant.has_additional_result'
        db.add_column('application_applicant', 'has_additional_result', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Applicant.additional_hashed_password'
        db.delete_column('application_applicant', 'additional_hashed_password')

        # Deleting field 'Applicant.has_additional_result'
        db.delete_column('application_applicant', 'has_additional_result')
    ...
    models = {
        ...
        'application.gpexamdate': {
            'Meta': {'ordering': "['rank']", 'object_name': 'GPExamDate'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
