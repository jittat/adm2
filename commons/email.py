...
def send_clearing_house_info_by_email(applicant, force=False):
    ...
    """
    subject = 'รหัสผ่านสำหรับเข้าระบบเคลียริงเฮาส์ โควตา สสวท./สอวน. คณะวิศวกรรมศาสตร์ ม.เกษตร'
...
http://www.cuas.or.th ตั้งแต่ วันที่ 11 -17 มีนาคม 2556
...
ที่เข้าร่วมในระบบเคลียริ่งเฮาส์ของปีการศึกษา 2556
...
% { 'firstname': applicant.first_name, 
    'lastname': applicant.last_name,
    'major': clearing_result.admitted_major,
