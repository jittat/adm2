...
def send_clearing_house_result_confirmation_email(applicant, force=False):
    subject = 'ยินดีต้อนรับสู่คณะวิศวกรรมศาสตร์ ม.เกษตรศาสตร์ (รายงานตัวเพื่อรับเอกสารมอบตัว 14 พ.ค.)'

    message = (
u"""เรียนคุณ %(firstname)s %(lastname)s ผู้ผ่านการคัดเลือกเข้าศึกษาต่อ

ยินดีต้อนรับเข้าสู่คณะวิศวกรรมศาสตร์ มหาวิทยาลัยเกษตรศาสตร์

ผู้ผ่านการคัดเลือกเป็นนิสิตใหม่ต้องมารายงานตัว เพื่อยื่นเอกสารสำคัญ ใบระเบียนแสดงผลการเรียน และรับเอกสารมอบตัว ในวันจันทร์ที่ 14 พฤษภาคม พ.ศ. 2555  ณ อาคารบุญสมสุวชิรัตน์ คณะวิศวกรรมศาสตร์ มหาวิทยาลัยเกษตรศาสตร์ วิทยาเขตบางเขน ตามกำหนดการดังนี้

รอบเช้า (สำหรับภาคปกติ)
09.00 - 09.30  ลงทะเบียนรายงานตัวเป็นนิสิตใหม่ ภาคปกติ
09.15 - 10.45  ตรวจเอกสาร และรับเอกสารมอบตัวนิสิตใหม่ ภาคปกติ

รอบบ่าย (ภาคพิเศษและนานาชาติ)
13.30 - 14.00  ลงทะเบียนรายงานตัวเป็นนิสิตใหม่ ภาคพิเศษและนานาชาติ
13.45 - 15.15  ตรวจเอกสาร และรับเอกสารมอบตัวนิสิตใหม่ ภาคพิเศษและนานาชาติ

หลักฐานที่ต้องนำมาแสดงในวันรายงานตัว
1. บัตรประจำตัวประชาชน หรือ Passport (กรณีเป็นชาวต่างชาติ)
2. สำเนาบัตรประจำตัวประชาชน 1 ฉบับ หรือ A Copy of the Passport (กรณีเป็นชาวต่างชาติ)
3. ใบระเบียนแสดงผลการเรียน (หรือ ปพ.1) ฉบับจริง  (Transcript)
4. สำเนาใบระเบียนแสดงผลการเรียน 1 ฉบับ  (A Copy of the Transcript)

สำเนาเอกสารทุกฉบับต้องลงนามรับรองสำเนาถูกต้อง ผู้เข้ารายงานตัวต้องมีคุณสมบัติทั่วไปและคุณสมบัติเฉพาะของคณะ/สาขาวิชาวิศวกรรมศาสตร์ ของคณะกรรมการการคัดเลือกบุคคลเข้าศึกษาในสถาบันอุดมศึกษา ซึ่งจะประกาศรายละเอียดที่ทางหน้าเว็บ http://admission.eng.ku.ac.th และแฟนเพจที่เฟสบุ๊คต่อไป

สำหรับวันมอบตัว ทางมหาวิทยาลัยได้กำหนดเป็นช่วงระหว่างวันที่ 5 - 8 มิ.ย. 2555 ซึ่งกำหนดการที่แน่นอนสำหรับคณะวิศวกรรมศาสตร์จะประกาศต่อไป

นอกจากนี้ในวันที่ 21 พ.ค. นิสิตใหม่ คณะวิศวกรรมศาสตร์ จะต้องเข้าร่วมกิจกรรมโครงการก้าวแรกสู่บัณฑิตยุคใหม่ ปีการศึกษา 2555 ซึ่งเป็นกิจกรรมที่จัดโดยมหาวิทยาลัยเกษตรศาสตร์

ขณะนี้ทางสำนักทะเบียนและประมวลผล ได้ประกาศปฏิทินการศึกษาปี 2555 (ฉบับร่าง) แล้ว สามารถอ่านได้จากลิงก์ต่อไปนี้ http://www.registrar.ku.ac.th/node/253 ซึ่งกำหนดการดังกล่าวจะเป็นกำหนดการของนิสิตภาคปกติและภาคพิเศษ หลายกิจกรรมทางมหาวิทยาลัย (เช่นวันมอบตัว) ยังไม่ได้กำหนดวันที่แน่นอน ทางโครงการจะประกาศวันที่แน่นอนให้ทราบต่อไป
