...
def send_activation_by_email(applicant, activation_key, force=False):
    ...
    subject = 'รหัสสำหรับเปิดใช้งานบัญชีผู้ใช้สำหรับการสมัครเข้าศึกษาต่อคณะวิศวกรรมศาสตร์แบบโควตา มก.บางเขน'
    message = (
...
def send_submission_confirmation_by_email(applicant, force=False):
    ...
    greeting = u"จดหมายอิเล็กทรอนิกส์ฉบับนี้ ยืนยันว่าคณะวิศวกรรมศาสตร์ได้รับใบสมัครโครงการโควตาสอวน.หรือสสวท. ของคุณแล้ว"
...
def send_payment_acceptance_by_email(applicant, force=False):
    ...
    """
    subject = 'แจ้งการรับชำระค่าสมัคร โครงการโควตาสอวน.และสสวท. คณะวิศวกรรมศาสตร์ ม.เกษตรศาสตร์ บางเขน'
...
def quota_result_mail_body(applicant):
    result = applicant.get_latest_admission_result()
    
    if not result:
        return u"""เรียน คุณ %(first_name)s %(last_name)s

คุณไม่ผ่านการสัมภาษณ์สัมภาษณ์คัดเลือกเข้าศึกษาต่อประเภทโควตา ปีการศึกษา 2556

อย่างไรก็ตาม คุณยังสามารถสมัครเข้าคัดเลือกเข้าศึกษาต่อทางโครงการรับตรง ได้จนถึงวัน 15 ก.พ. 2555 
อ่านรายละเอียดได้ที่ http://admission.eng.ku.ac.th/2555/admission/direct

หมายเหตุ: ถ้าคุณได้รับเมล์นี้ โดยไม่ได้ตั้งใจสมัครเข้าศึกษาต่อคณะวิศวกรรมศาสตร์ในระบบ _โควตา_ สอวน. หรือ สสวท. อาจจะเป็นไปได้ที่คุณกรอกข้อมูลเข้าระบบรับสมัครผิดระบบ  ถ้าเป็นกรณีดังกล่าว ให้รีบติดต่อผู้ดูแลโดยส่งอีเมล์ไปที่ admission.eng.ku@gmail.com โดยด่วน
...
คุณจะต้องเข้าระบบยืนยันสิทธิ์ออนไลน์เพื่อยืนยันสิทธิ์ในวันที่ 18 - 19 ก.พ. 2555 เพื่อป้อนข้อมูลสำหรับการเคลียริงเฮาส์และรับรหัสผ่าน สำหรับการยืนยันสิทธิ์ผ่านทางโครงการเคลียริงเฮาส์ของ สอท ระหว่างวันที่ 11 - 17 มีนาคม 2555  คณะวิศวกรรมศาสตร์จะถือว่าคุณสละสิทธิ์ถ้าไม่มายืนยันสิทธิ์ตามเวลาที่กำหนด

ในกรณีที่คุณสมัครโครงการรับตรงและคุณได้รับคัดเลือกเข้าศึกษาต่อในโครงการรับตรงด้วย คุณจะต้องเลือกเข้าศึกษาต่อเฉพาะทางใดทางหนึ่งเท่านั้น &nbsp; ถ้าคุณได้รับคัดเลือกผ่านโครงการรับตรงในรอบที่สอง คุณอาจจะต้องเข้าระบบเพื่อยืนยันสิทธิ์อีกครั้งหนึ่งในวันที่ 25 - 26 ก.พ. 2555
