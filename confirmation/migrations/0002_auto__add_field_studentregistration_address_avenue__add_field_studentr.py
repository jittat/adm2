...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StudentRegistration.address_avenue'
        db.add_column('confirmation_studentregistration', 'address_avenue', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)

        # Adding field 'StudentRegistration.school_type'
        db.add_column('confirmation_studentregistration', 'school_type', self.gf('django.db.models.fields.CharField')(default=u'\xe0\xb9\x84\xe0\xb8\x97\xe0\xb8\xa2', max_length=15), keep_default=False)

        # Adding field 'StudentRegistration.GPA'
        db.add_column('confirmation_studentregistration', 'GPA', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'StudentRegistration.address_avenue'
        db.delete_column('confirmation_studentregistration', 'address_avenue')

        # Deleting field 'StudentRegistration.school_type'
        db.delete_column('confirmation_studentregistration', 'school_type')

        # Deleting field 'StudentRegistration.GPA'
        db.delete_column('confirmation_studentregistration', 'GPA')
