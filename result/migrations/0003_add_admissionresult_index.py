...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'AdmissionResult', fields ['round_number']
        db.create_index('result_admissionresult', ['applicant_id','round_number'],unique=True)


    def backwards(self, orm):
        
        # Removing index on 'AdmissionResult', fields ['round_number']
