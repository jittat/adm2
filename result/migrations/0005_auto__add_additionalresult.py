...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AdditionalResult'
        db.create_table('result_additionalresult', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('applicant', self.gf('django.db.models.fields.related.OneToOneField')(related_name='additional_result', unique=True, to=orm['application.Applicant'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('result', ['AdditionalResult'])


    def backwards(self, orm):
        
        # Deleting model 'AdditionalResult'
        db.delete_table('result_additionalresult')
