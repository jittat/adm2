...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AdmissionResult.waitlist_number'
        db.add_column('result_admissionresult', 'waitlist_number', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AdmissionResult.waitlist_number'
        db.delete_column('result_admissionresult', 'waitlist_number')
