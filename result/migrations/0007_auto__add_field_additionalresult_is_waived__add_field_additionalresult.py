...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AdditionalResult.is_waived'
        db.add_column('result_additionalresult', 'is_waived', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'AdditionalResult.waived_at'
        db.add_column('result_additionalresult', 'waived_at', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AdditionalResult.is_waived'
        db.delete_column('result_additionalresult', 'is_waived')

        # Deleting field 'AdditionalResult.waived_at'
        db.delete_column('result_additionalresult', 'waived_at')
