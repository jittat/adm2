...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ClearingHouseResult'
        db.create_table('result_clearinghouseresult', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('applicant', self.gf('django.db.models.fields.related.OneToOneField')(related_name='clearing_house_result', unique=True, to=orm['application.Applicant'])),
            ('admitted_major', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['application.Major'], null=True)),
            ('is_additional_result', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('password', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal('result', ['ClearingHouseResult'])


    def backwards(self, orm):
        
        # Deleting model 'ClearingHouseResult'
        db.delete_table('result_clearinghouseresult')
    ...
    models = {
        ...
        'result.additionalresult': {
            'Meta': {'ordering': "['round_number', 'name']", 'object_name': 'AdditionalResult'},
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_waived': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'round_number': ('django.db.models.fields.IntegerField', [], {}),
            'waived_at': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'})
        },
        ...
        'result.clearinghouseresult': {
            'Meta': {'object_name': 'ClearingHouseResult'},
            'admitted_major': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['application.Major']", 'null': 'True'}),
            'applicant': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'clearing_house_result'", 'unique': 'True', 'to': "orm['application.Applicant']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_additional_result': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
