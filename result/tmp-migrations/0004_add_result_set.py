...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ReportCategory.result_set_id'
        db.add_column('result_reportcategory', 'result_set_id', orm['result.reportcategory:result_set_id'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'ReportCategory.result_set_id'
        db.delete_column('result_reportcategory', 'result_set_id')
