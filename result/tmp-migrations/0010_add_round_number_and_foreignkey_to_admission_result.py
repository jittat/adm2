...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AdmissionResult.round_number'
        db.add_column('result_admissionresult', 'round_number', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Changing field 'AdmissionResult.applicant'
        db.alter_column('result_admissionresult', 'applicant_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['application.Applicant']))

        # Removing unique constraint on 'admissionresult', fields ['applicant']
        db.delete_unique('result_admissionresult', ['applicant_id'])


    def backwards(self, orm):
        
        # Deleting field 'AdmissionResult.round_number'
        db.delete_column('result_admissionresult', 'round_number')

        # Changing field 'AdmissionResult.applicant'
        db.alter_column('result_admissionresult', 'applicant_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['application.Applicant']))

        # Adding unique constraint on 'admissionresult', fields ['applicant']
