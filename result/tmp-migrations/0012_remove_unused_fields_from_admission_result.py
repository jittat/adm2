...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('result_admissionresult', 'is_final_admitted', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'AdmissionResult.final_admitted_major'
        db.add_column('result_admissionresult', 'final_admitted_major', self.gf('django.db.models.fields.related.ForeignKey')(related_name='final_results', null=True, to=orm['application.Major']), keep_default=False)
